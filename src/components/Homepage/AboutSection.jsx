          ...
          <div className="space-y-6 sm:space-y-8">
            <div>
              ...
              <p className="text-sm sm:text-base text-gray-600">
                ...
                create their perfect indoor and outdoor spaces. Our mission is
                to make plant parenthood accessible and enjoyable for everyone.
              </p>
            </div>
            <div className="space-y-4 sm:space-y-6">
              {highlights.map((highlight) => (
                <div key={highlight.id} className="flex items-start gap-4">
                  <div className="text-3xl sm:text-4xl">{highlight.icon}</div>
                  <div>
