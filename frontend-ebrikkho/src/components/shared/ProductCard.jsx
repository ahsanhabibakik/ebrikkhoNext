    ...
    <>
      ...
      >
        <div className="relative">
          ...
          {product.isNew && (
            <div className="absolute top-2 left-2 bg-green-500 text-white text-xs font-semibold px-2 py-1 rounded shadow-sm">
              New
            </div>
          )}
          ...
          {discountPercent && (
            <div className="absolute bottom-2 left-2 bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded shadow-sm">
              {discountPercent}% Off
            </div>
          )}
          <button
            onClick={toggleFavorite}
            className="absolute top-2 right-2 bg-white/80 text-gray-600 p-1.5 rounded-full hover:bg-white transition-colors shadow-sm"
          >
            {isFavorite ? (
        ...
        <div className="p-4 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-auto">
            ...
            <button
              ...
              className="bg-orange-600 text-white p-2 rounded-lg hover:bg-orange-700 transition-colors shadow-sm"
            >
